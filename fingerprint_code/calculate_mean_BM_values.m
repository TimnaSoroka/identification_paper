function[mean_values_all,excluded] =calculate_mean_BM_values(AllSubjData,directory_to_use,block_length,WSA,timings,start,normalize,overlap,cleaning,exclude_shorts)
...
for sbj=1:size(AllSubjData,2)
    ...
    if normalize
        ...
        file=dir([ directory_to_use '/code/breathMetric_parameters/BM_param_' num2str(block_length) 'min_blocks_per_subj/' SubjectName '/' SubjectName '_zelano_' WSA '_*p.mat']);
    end
