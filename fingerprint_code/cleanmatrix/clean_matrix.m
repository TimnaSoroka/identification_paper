%clean matrix example
%load('training_mat_97_0.85_400features.mat');
load('/Users/timnas/Documents/projects/identification_Zelano/zelano_train_test_full97wake_no_overlap.mat');

mat=table2array(training_mat);
...
mat4 = replace_nans(mat3, 1); 
fprintf('After replacing nans: (%d, %d)\n', size(mat4))

[mat5, rows_idxs] = remove_extreme_norm_rows(mat4, EXTREME_MOLECULES_REMOVAL);
