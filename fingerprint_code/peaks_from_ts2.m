function[inhales_and_exhales_properties_passed_threshold]=peaks_from_ts2(TimeSeries,Fs)
%length parameters
...
inhales_and_exhales_properties = nested_FindPeaksProperties_TS(sampleLength, duration_of_neigbors_for_baseline_in_minutes, TimeSeries, all_relevant_locations_indices);
