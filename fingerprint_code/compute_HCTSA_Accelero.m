...
save([directory_to_use '/HCTSA_' list(i).name(5:end)],'TS_Quality','TS_DataMat','TS_CalcTime',"TimeSeries",'Operations','MasterOperations','gitInfo','fromDatabase');
delete('HCTSA.mat')
delete('INP_test.mat')
end
