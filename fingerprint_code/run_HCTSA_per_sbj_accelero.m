function run_HCTSA_per_sbj_accelero(parameters,AllSubjData,directory,WSA,normalize,overlap,cleaning,block_length,train_by_hours,prc_train,timings,start)
...
% if normalize
if strcmpi('wake',WSA)
file=dir([directory '/Accelerometer/HCTSA//HCTSA_' SubjectName(1:4) '_5min_magnitude.mat']);
 else
...
% 
        ...
        save([directory '/result_HCTSA_same_day/accelero_HCTSA_'  WSA '_' num2str(block_length) 'min_blocks_' num2str(prc_train) '_' num2str(timings(iii)) 'min_no_overlap_' num2str(s) 'first_parameters_' num2str(size(AllSubjData,2)) '.mat'],'C',"labels_hat", 'zelano_testing_labels','parameters');
end
end