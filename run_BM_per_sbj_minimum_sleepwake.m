...
labels=repmat({SubjectName},size(Data_per_subject,1),1);
    ...
    if rand
        ...
        if overlap
            ...
            save([directory '/result_BM_same_day/acc_id_zelano_'  WSA '_' num2str(block_length) 'min_blocks_' num2str(prc_train) '_' num2str(timings(iii)) 'min_no_overlap_' num2str(size(AllSubjData,2)) 'wake_capped.mat'],"acc",'acc_id','validationAccuracyReal',"labels_hat", 'zelano_testing_labels');
        end
    end
end
end