...
run_BM_between_days(AllSubjData_day1,AllSubjData_day2,directory_to_use,WSA,normalize,...
...
acc_id=run_BM_between_days(AllSubjData_new,AllSubjData_day2,directory_to_use,WSA,normalize,...
    overlap,cleaning,block_length_in_minutes,train_by_hours,prc_train,timings,start);
...
save([directory_to_use '/result_BM_between_days/extrapolation_results_' WSA '.mat'],"acc_id_per_extrapolation","subj_list");
end