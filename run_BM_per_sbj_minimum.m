function acc_id=run_BM_per_sbj_minimum(AllSubjData,directory,WSA,normalize,overlap,cleaning,block_length,train_by_hours,prc_train,timings,start,rand)
...
for iii=1:length(timings)
    ...
    for perm=1:5
        [mdl, validationAccuracyReal(perm)] = mediumNeuralNetworkK(zelano_mat(:,params),zelano_labels);
